            ...
            <div className={styles.wrapperContentHero}>
              <div className={styles.appLeftContentHero}>
                ...
                <div className={styles.appContentScrollArrow}>
                  <div ref={refRotateText} className={styles.contentCircleText}>
            ...
            <div className={styles.appContentAboutMeDescription}>
              <div className={styles.wrapperAboutMeDescription}>
                ...
                >
                  ...
                  experiencia en proyectos personales manejando tecnologías
                  como, ReactJs, Javascript, Redux, Sass, Css3, Html5, Git,
                  Styled Components.
                </p>
                <p
                  data-text="text"
                ...
                >
                  ...
                  lograrse entre el producto que se desarrolle y el usuario
                  final, ya sea mediante una página web, alguna aplicación web,
                  que satisfaga alguna necesidad, me motiva estar en constante
              ...
              <div className={styles.contentSkills}>
                <ul className={styles.contentItemSkills}>
                  <div className={styles.flexSkills}>
                    {svgIcons.map((icon) => (
                      <div
                        className={styles.contentSkillsLabel}
                        key={icon.name}
                      >
              ...
              <div className={styles.appLeftContentChallenge}>
                ...
                <div className={styles.challengeMyExplanation}>
                  <p data-text="text" className={styles.pMyExplanation}>
                    ...
                    desarrollo de una app funcional, el desafío consistía en
